		...
		extend: {
			colors: {
				...
				dark: {
					...
					accent: '#403E43', // charcoal gray
				},
				// Custom colors for our application
				pi: {
					DEFAULT: '#FCFCFC', // almost white for text
					muted: '#8E9196', // neutral gray
					accent: '#D6D6D6', // light gray accent
					focus: '#A0A5D7', // soft blue/purple focus
				},
				sidebar: {
			...
			backgroundImage: {
				...
				'dark-gradient': 'linear-gradient(to bottom right, #1A1F2C, #121720)',
